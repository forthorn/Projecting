...
//        File cacheFile = new File(AppApplication.getAppContext().getCacheDir(), "cache");
        File cacheFile = new File(AppApplication.getApplication().getCacheDir(), "cache");
    ...
    public static String getCacheControl() {
        return NetWorkUtils.isNetConnected(AppApplication.getContext()) ? CACHE_CONTROL_AGE : CACHE_CONTROL_CACHE;
    }
