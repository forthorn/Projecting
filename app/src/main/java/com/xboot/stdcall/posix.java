...
/**
 * Created by Yongz on 2016/10/10.
 */
...
public class posix {
    ...
    // smdt add 2012-11-14
    public final static native int poweronoff(byte off_h, byte off_m, byte on_h,
                                              byte on_m, byte enable, int fd);
    ...
    public final static native int setck(byte enable, int fd);
